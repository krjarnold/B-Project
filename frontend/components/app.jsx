      ...
      <div className="app-container">
        <header className="header">
          <nav className="navbar">
            <Link className="nav-logo" to="/">BONOBOS</Link>
          </nav>
        </header>
        <div className="app-product-list">
          <ProductList/>
        <footer className= "footer-container">
          <a className="footer-bonobos-link"
             href= "https://bonobos.com/">
             Check out our other great merchandise!
          </a>
          <div className= "footer-created-container">
            <a className= "footer-created-by"
              href= "http://www.kaelynarnold.com/">
              Created by: Kaelyn Arnold
            </a>
            <a className= "footer-github"
               href= "https://github.com/krjarnold/B-Project">
               <svg className= "footer-svg" viewBox="0 0 128 128">
